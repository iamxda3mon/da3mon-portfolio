const translations = {
    de: {
        ...
        'privacy.h_web3forms': 'Web3Forms (Kontaktformular)',
        'privacy.p_web3forms1': 'Wenn Sie das Kontaktformular absenden, werden Ihr Name, Ihre E-Mail-Adresse und Ihre Nachricht an Web3Forms, Inc. übermittelt und per E-Mail an den Seiteninhaber weitergeleitet. Web3Forms handelt ausschließlich als Auftragsverarbeiter für diesen Zweck und löscht die Daten nach der Weiterleitung.',
        'privacy.p_web3forms2': 'Die Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO – Verarbeitung zur Beantwortung Ihrer Kontaktanfrage. Datenschutzerklärung von Web3Forms:',
    ...
    en: {
        ...
        'privacy.h_web3forms': 'Web3Forms (Contact Form)',
        'privacy.p_web3forms1': 'When you submit the contact form, your name, email address, and message are transmitted to Web3Forms, Inc. and forwarded to the site owner by email. Web3Forms acts as a data processor solely for this purpose and deletes the data after forwarding.',
        'privacy.p_web3forms2': 'The legal basis is Art. 6(1)(b) GDPR — processing necessary to respond to your contact request. Web3Forms privacy policy:',
